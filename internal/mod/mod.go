...
func Write(mod, name string) error {
	if err := writer.WriteToFile(modTemplate(mod), name, "go.mod"); err != nil {
		return err
	}
	return writer.WriteToFile(sumTemplate(), name, "go.sum")
}

func modTemplate(mod string) string {
